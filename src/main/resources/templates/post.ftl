      ...
      <div class="col-lg-8">
        ...
        <div>
          ...
          <div style="float: right">
            <a href="/dislike/${articulo.id}" class="btn btn-danger">
              <span class="far fa-thumbs-down"></span> Dislike (${cantDislikes})</a>

            <a href="/like/${articulo.id}" class="btn btn-success">
              <span class="far fa-thumbs-up"></span> Like (${cantLikes})</a>
          </div>
